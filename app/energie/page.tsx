...
export default function Energie() {
  ...
  return <main className="energyPage">
    <header className="nav"><a className="brand" href="/"><Logo/><b>ENERGIE-CHECK</b></a><nav><a href="#energie-start">Check starten</a><a href="#ablauf">So geht&apos;s</a><a href="#faq">FAQ</a><a href="/">Vertrieb</a></nav><a className="navCta" href="#energie-start">Check starten ↘</a></header>
    ...
    <footer><a className="brand" href="/"><Logo/><b>ENERGIE-CHECK</b></a><div><a href="/impressum">Impressum</a><a href="/datenschutz">Datenschutz</a></div><p>Keine pauschale Ersparnis- oder Abschlussgarantie.</p><span>© 2026 JL VERTRIEB</span></footer>
  </main>;
}
